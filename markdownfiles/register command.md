...
1. Выбор роли для которой будет рассылка  
2. получение списка менеджеров (сделать через query)
3. получение текста сообщения (из бд)
4.  статус сообщения null -> mailing
5. отправка сообщения всем менеджерам
